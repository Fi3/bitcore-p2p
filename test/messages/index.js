...
describe('Messages', function() {
  ...
  describe('#parseBuffer', function() {
    ...
    it('fail with invalid filter', function() {
      ...
      var fails = function() {
        messages.parseBuffer(buildMessage(invalidFilter));
      };
      fails.should.throw('Data object should include number of hash functions' +
        ' "nHashFuncs"');
    });
  });
